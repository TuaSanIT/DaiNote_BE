...
public class TaskController : ControllerBase
{
    ...
    public TaskController(ITaskRepository taskRepository, IDragAndDropRepository dragAndDropRepository, IConfiguration configuration, AzureBlobService storageService, UserManager<UserModel> userManager)
    {
    ...
    public async Task<ActionResult<TaskModel>> UpdateTask(Guid id, [FromForm] PUT_Task updatedTask)
    {
        ...
        if (updatedTask.AssignTo.HasValue && updatedTask.AssignTo != previousAssigneeId)
        {
